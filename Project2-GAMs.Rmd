...
# Re-index the time
i_df$time <- i_df$time - (i_df$time[1] + 4000)
i_df <- i_df[ (i_df$time > 0),]
# Remove outliers
i_df <- i_df[ !(i_df$hr > 90),]
...
GAM itself can be a very wide and deep topic. The following resources might also be of interest to the viewer:
